...
**GNC** = gender non-conforming. For the purpose of this project: specifically gnc in an aesthetic/style sense <br>
...
**GENDER DIVERSE** = Umbrella term for gender minorities (ex. trans, intersex, gnc, etc) <br>
